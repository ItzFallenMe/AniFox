...
class AniFox extends StatefulWidget {
  const AniFox({super.key});

  static final GlobalKey<ScaffoldMessengerState> snackbarKey = GlobalKey<ScaffoldMessengerState>();

  static final navigatorKey = GlobalKey<NavigatorState>();
  @override
  State<AniFox> createState() => _AniFoxState();
}

class _AniFoxState extends State<AniFox> {
    ...
    return AnnotatedRegion(
      ...
      child: DynamicColorBuilder(
        builder: (lightScheme, darkScheme) {
          ...
          return MaterialApp(
            title: 'AniFox',
            navigatorKey: AniFox.navigatorKey,
            scaffoldMessengerKey: AniFox.snackbarKey,
            theme: ThemeData(
                useMaterial3: true,
