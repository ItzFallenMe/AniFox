...
class _AnimeListsState extends State<AnimeLists> with TickerProviderStateMixin {
  ...
  final railController = AniFoxBottomBarController(length: 4);
                      ...
                      children: [
                        if (Platform.isWindows || Platform.isLinux)
                          AniFoxNavRail(
                              shouldExpand: true,
                              destinations: [
                                const AniFoxNavDestination(icon: Icons.movie, label: "Watching"),
                                const AniFoxNavDestination(icon: Icons.calendar_month, label: "Planned"),
                                const AniFoxNavDestination(icon: Icons.highlight_off_outlined, label: "Dropped"),
                                const AniFoxNavDestination(icon: Icons.task_alt_rounded, label: "Completed")
                              ],
