...
import 'package:anifox/core/app/update.dart';
...
import 'package:anifox/ui/models/widgets/floatyBar/floatyBarView.dart';
import 'package:anifox/ui/models/widgets/floatyBar/floatyBottomBar.dart';
...
class MainNavigatorState extends State<MainNavigator> with TickerProviderStateMixin {
  ...
  final _barController = AniFoxBottomBarController(length: 3);
        ...
        body: MediaQuery.of(context).orientation == Orientation.landscape || Platform.isWindows || Platform.isLinux
            ? Row(
                children: [
                  // AniFoxNavRail(
                  //   destinations: [
                  //     AniFoxNavDestination(icon: Icons.home, label: "Home"),
                  //     AniFoxNavDestination(icon: Icons.auto_awesome, label: "Discover"),
                  //     AniFoxNavDestination(icon: Icons.search, label: "Search"),
                  //   ],
