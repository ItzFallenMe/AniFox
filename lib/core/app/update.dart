...
import 'package:anifox/ui/models/bottomSheets/updateSheet.dart';
...
Future<UpdateCheckResult?> checkForUpdates() async {
  ...
  try {
    final releasesUrl = 'https://api.github.com/repos/ItzFallenMe/AniFox/releases';
    ...
    if (triggerSheet || isAnUpgrade) {
      ...
      final List<dynamic> asset = releasesRes['assets']
          .where((item) => item['name'] == (Platform.isAndroid ? "app-release.apk" : "anifox-x86_64.exe"))
          .toList();
